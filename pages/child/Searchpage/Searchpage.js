        ...
        if (that.data.changeJob != '全职') {
          for (let i in res.data.data.list) {
            ...
            let lists = {
              fn: 'detail',
              //sex: i % 2 == 0 ? '女' : '男',
              tille: res.data.data.list[i].certificate.length == 0 ? res.data.data.list[i].title : `${res.data.data.list[i].certificate[0].fir_type_name}-${res.data.data.list[i].certificate[0].sec_type_name}`,
              name: res.data.data.list[i].name,
              area: res.data.data.list[i].certificate.length == 0 ? `${res.data.data.list[i].city}` : `${res.data.data.list[i].certificate[0].province}${res.data.data.list[i].certificate[0].city}`,
              stats: i % 2 == 0 ? '资质' : '不限',
            ...
            if (res.data.data.list[i].sex == 0) {
              lists.sex = '男'
            } else if (res.data.data.list[i].sex == 1) {
              lists.sex = '男'
            } else if (res.data.data.list[i].sex == 2) {
              lists.sex = '女'
            } else {
              lists.sex = res.data.data.list[i].sex
            }
            ;
            list.push(lists)
          }
          ...
          for (let i in res.data.data.list) {
            ...
            let lists = {
              fn: 'detail',
              tille: res.data.data.list[i].work,
              name: res.data.data.list[i].name,
              education: res.data.data.list[i].education,
